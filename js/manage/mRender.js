...
{
    var url = config.apiPath + 'php/videoFileManagement.php?action=list&projectName='+currentProject.name;
    ...
    xhr.onload = function() {
        ...
        {
            var url2 = config.apiPath + 'php/videoFileManagement.php?action=read&id='+jsonRep[i]+'&projectName='+currentProject.name;
...
{
    var url = config.apiPath + 'php/videoFileManagement.php?action=delete&id='+id+'&projectName='+currentProject.name;
...
{
    document.getElementById('videoRender').src = config.apiPath + 'php/videoFileManagement.php?action=read&id='+id.split(".")[0]+'_WEB.mp4'+'&projectName='+currentProject.name;
